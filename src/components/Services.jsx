import { BookOpen, Cloud, Users, ArrowRight, Infinity } from "lucide-react";
...
const services = [
  {
    ...
    description:
      "Hands-on, industry-ready courses designed to upskill learners in Cloud, DevOps, automation, and modern infrastructure practices.",
    features: [
  ...
  },
  {
    ...
    description:
      "Deeply insightful books focused on DevOps concepts, real-world implementations, and career guidance for aspiring cloud engineers.",
    features: [
  ...
  },
  {
    ...
    description:
      "Helping brands and businesses with Cloud solution architecture, DevOps adoption, infrastructure modernization, and strategic technology consulting.",
    features: [
