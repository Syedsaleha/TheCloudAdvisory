...
{/* WEEK TIMELINE – MEDIUM SIZE */} <section className="py-20 px-6 max-w-5xl mx-auto"> <h2 className="text-4xl font-bold text-center mb-16">14-Week DevOps Roadmap</h2> <div className="relative"> {/* Center Line */} <div className="absolute left-1/2 top-0 bottom-0 w-[3px] bg-yellow-400 transform -translate-x-1/2"></div> {weeks.map((w, i) => ( <div key={i} className={mb-14 flex w-full ${ i % 2 === 0 ? "justify-start" : "justify-end" }} data-aos="fade-up" data-aos-delay={i * 70} > <div className="w-[50%] px-6 relative"> {/* Dot */} <div className="absolute top-4 w-5 h-5 bg-yellow-400 border-4 border-white rounded-full shadow-md" style={{ left: i % 2 === 0 ? "100%" : "0%", transform: "translate(-50%, 0)", }} ></div> {/* Card */} <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition border border-gray-200"> <h3 className="text-2xl font-bold text-black mb-1">{w.week}</h3> <p className="text-gray-700 text-base leading-relaxed"> {w.topic} </p> </div> </div> </div> ))} {/* FINAL ACHIEVEMENT CARD */} <div className="flex justify-center mt-20" data-aos="zoom-in"> <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-black p-6 rounded-2xl shadow-xl border border-yellow-600 text-center w-[70%]"> <h3 className="text-2xl font-bold">🎉 Congratulations!</h3> <p className="text-md mt-1 font-medium"> You have completed the 14-Week DevOps Micro Internship Journey. </p> </div> </div> </div> </section>
